...
class Display extends TopLevel implements Observer {
    ...
    Display(String title, Game game, Writer commandWriter) {
        ...
        addMenuRadioButton("Options->Red Manual", "Red Player", true,
                "redManual");
        addMenuRadioButton("Options->Red AI", "Red Player", false, "redAI");
        addMenuRadioButton("Options->Blue Manual", "Blue Player", false,
                "blueManual");
    ...
    /**
     * Sets number of squares red and blue has.
     * @param redScore # red squares
     * @param blueScore # blue squares
     */
